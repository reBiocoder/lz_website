...
// 设置URL
const requestHost = '127.0.0.1:18882'
...
module.exports = function (ctx) {
  return {
    ...
    framework: {
      ...
      // Quasar plugins
      plugins: ['Notify', 'LocalStorage', 'SessionStorage', 'LoadingBar', 'Loading']
    },
    ...
    build: {
      ...
      env: Object.assign(serviceUrl, {APP_SCOPE_NAME: scopeName,}),
